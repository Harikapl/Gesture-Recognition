...
You want to develop a cool feature in the state of the art smart televisions that can recognise five different gestures performed by the user which will help users control the TV without using a remote. 
